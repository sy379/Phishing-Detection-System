    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      ...
      <div className="w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Join PhishDetect today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass rounded-2xl p-8 space-y-5 glow">
          ...
          <div>
            ...
            <input
              ...
              className="input-modern w-full" placeholder="John Doe" required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="input-modern w-full" placeholder="••••••••" required minLength={6}
            />
